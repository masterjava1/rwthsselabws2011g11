...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Apr 11 19:39:27 2012
# Project:  Test1.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		StepperBase.cpp \
		RHS_van.cpp \
		RuntimeException.cpp moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Test11.0.0/ && $(COPY_FILE) --parents mainwindow.h exportdialog.h parameter.h warningdialog.h errordialog.h parset.h Odeint.h Output.h RHS_gyro.h StepperDopr853m.h ntl_ext.h StepperBase.h write_tec.h RuntimeException.h RHS_van.h .tmp/Test11.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp exportdialog.cpp parameter.cpp warningdialog.cpp errordialog.cpp parset.cpp ntl_ext.cpp StepperBase.cpp RHS_van.cpp RuntimeException.cpp .tmp/Test11.0.0/ && $(COPY_FILE) --parents mainwindow.ui exportdialog.ui parameter.ui warningdialog.ui errordialog.ui .tmp/Test11.0.0/ && (cd `dirname .tmp/Test11.0.0` && $(TAR) Test11.0.0.tar Test11.0.0 && $(COMPRESS) Test11.0.0.tar) && $(MOVE) `dirname .tmp/Test11.0.0`/Test11.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Test11.0.0
